...
namespace NotesSystem.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idStudent,name,Idgrade,age")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idStudent,name,Idgrade,age")] Student student)
        {
