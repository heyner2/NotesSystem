...
namespace NotesSystem.Controllers
{
    public class GradesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idGrade,gradeText")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idGrade,gradeText")] Grade grade)
        {
            if (id != grade.idGrade)
            {
                return NotFound();
